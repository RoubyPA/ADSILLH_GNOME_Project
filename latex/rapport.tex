...
Nous avons encore rencontré un ou deux petit problèmes, notament une erreur
dans la fonction que nous avions écrite, nous avions échenger le \texttt{true}
...
\texttt{8} afin de garder un code lisible. Le mainteneur a d'ailleur été

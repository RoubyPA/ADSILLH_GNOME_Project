...
Le premier problème qui nous à fait perdre beaucoup de temps venait de notre
...
pas bien gérée par \textit{Qemu}, il nous a donc fallut lié le fichier de
la sourie \texttt{/dev/bus/usb/00x/00x} à notre VM afin quelle soit reconnus
...
de l'aide sur le Chanel \textit{vala} de l'\texttt{irc} GNOME, mais nous
n'avons pas trouvé d'aide.

Au final nous avons ajouté un bout de code pour capter tous les événements et
les afficher, ainsi nous avons réussi à déterminé que le code de l’événement
et le \texttt{8}.

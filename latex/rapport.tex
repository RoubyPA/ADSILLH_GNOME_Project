...
\newpage
\section{Conclusion}
Ce projet nous à permit de découvrir la contribution aux logiciel libre.
Nous avons eu location d'intéragire avec la communauté et de participé à
l'améloration du logiciel.
Cette expérience nous à permit de nous perfexionner avec git, mais aussi
à découvrire les bonnes lors du développement participatif.

Nous avons rencomtré des difficultés.

Et il n'est plus que probable que dans le future nous contributions à
d'autre projet dans notre cadre personnelle.
%% Ce projet nous à permit de nous accoutumer au développement

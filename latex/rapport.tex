...
Nous avons donc put déterminé que la fonction
...
de pulsaudio qui provique le crach.
\begin{minted}[breaklines]{c}
...
Après quelque test et une vérification dans les sources nous somme avenue à montré
que la fonction ``retro\_pa\_player\_prepare\_for\_sample\_rate'' position ``self''
à ``NULL'' si pulseaudio n'est pas disponible.
